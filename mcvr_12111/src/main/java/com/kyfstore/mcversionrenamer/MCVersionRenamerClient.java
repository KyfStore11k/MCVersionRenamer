...
public class MCVersionRenamerClient implements ClientModInitializer {
    ...
    private static String versionName = "Minecraft* " + SharedConstants.getGameVersion().name();
    ...
    public void onInitializeClient() {
        ...
        guiToggleKeyBinding = KeyBindingHelper.registerKeyBinding(
                new KeyBinding(
                        ...
                        KeyBinding.Category.create(Identifier.of("category.mcversionrenamer.default.name"))
                )
        );
