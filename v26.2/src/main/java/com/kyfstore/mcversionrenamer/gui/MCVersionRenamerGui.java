...
public class MCVersionRenamerGui extends LightweightGuiDescription {
    ...
    public MCVersionRenamerGui(Screen lastScreen) {
        ...
        try {
            button.setIcon(new ItemIcon(new ItemStack(Items.WOOL.lime())));
        } catch (Exception e) {
        ...
        closeButton.setOnClick(() -> Minecraft.getInstance().setScreenAndShow(lastScreen));

        WButton defaultButton = new WButton(Component.literal("Default"));
        try {
            defaultButton.setIcon(new ItemIcon(new ItemStack(Items.WOOL.white())));
        } catch (Exception e) {
        ...
        openConfigButton.setOnClick(() -> {
           Minecraft.getInstance().setScreenAndShow(MCVersionRenamerConfig.createConfigScreen(Minecraft.getInstance().gui.screen()));
        });
