...
public class MCVersionRenamerClient implements ClientModInitializer {
    ...
    private static String versionName = "Minecraft* " + SharedConstants.getCurrentVersion().getName();
    ...
    public void onInitializeClient() {
        ...
        guiToggleKeyBinding = KeyBindingHelper.registerKeyBinding(
                new KeyMapping(
                        ...
                        "key.category.minecraft.category.mcversionrenamer.default.name"                )
        );
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (!hasCheckedVersion && client.screen instanceof TitleScreen) {
