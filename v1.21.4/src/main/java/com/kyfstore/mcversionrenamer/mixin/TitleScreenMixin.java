...
public abstract class TitleScreenMixin extends Screen {
    ...
    private void renderCustomVersion(GuiGraphics context, int mouseX, int mouseY, float delta, CallbackInfo ci) {
        Minecraft client = Minecraft.getInstance();
        Font textRenderer = client.font;

        TextColor configColor = TextColor.fromRgb(net.minecraft.ChatFormatting.WHITE.getColor());
    ...
    private void onInit(CallbackInfo ci) {
        this.splash = new SplashRenderer(MCVersionRenamerConfig.splashText);
    }
}